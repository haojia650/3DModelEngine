...
BEGIN_MESSAGE_MAP(COccResurfApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &COccResurfApp::OnAppAbout)
	// 基于文件的标准文档命令
...
COccResurfApp::COccResurfApp() noexcept
{
	...
	SetAppID(_T("OccResurf.AppID.NoVersion"));
...
// 唯一的 COccResurfApp 对象

COccResurfApp theApp;


// COccResurfApp 初始化

BOOL COccResurfApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(COccResurfDoc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架窗口
		RUNTIME_CLASS(COccResurfView));
	if (!pDocTemplate)
		return FALSE;
...
int COccResurfApp::ExitInstance()
{
	//TODO: 处理可能已添加的附加资源
	AfxOleTerm(FALSE);
...
// 用于运行对话框的应用程序命令
void COccResurfApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// COccResurfApp 自定义加载/保存方法

void COccResurfApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
